...
\begin{figure}[h]
  \begin{center}
    \begin{tabular}{c}
        \includegraphics[width=1.0\textwidth]{fig_FastTiming/CurrentDensity_xray.png}
    \end{tabular}
...
\begin{figure}[h]
  \begin{center}
    \begin{tabular}{c}
        \includegraphics[width=1.0\textwidth]{fig_FastTiming/CurrentDensity_MIP.png}
    \end{tabular}
...
\begin{figure}[h]
  \begin{center}
    \begin{tabular}{c}
        \includegraphics[width=1.0\textwidth]{fig_FastTiming/Signal_xray_Multi.png}
    \end{tabular}
...
\begin{figure}[h]
  \begin{center}
    \begin{tabular}{c}
        \includegraphics[width=1.0\textwidth]{fig_FastTiming/Signal_MIP_Multi.png}
    \end{tabular}
...
\begin{figure}[h]
  \begin{center}
    \begin{tabular}{c}
      \includegraphics[width=0.5\textwidth]{fig_FastTiming/Signal_xray.png}
    \end{tabular}
