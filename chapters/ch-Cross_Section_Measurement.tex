...
\begin{itemize}
    ...
    To assess the systematic variation of correcting the top quark \pT in the MC simulation to that measured in data, we use the top \pT reweighting function: $e^{p+q \cdot p_T}$, with $p = 0.0615$ and $q = -0.0005$, derived from data recorded at \beamenergy.
    ...
    \begin{figure}
      \begin{center}
        \includegraphics[width=0.425\textwidth]{fig_fullRun2UL/controlplots/combined/HypToppT.pdf}
        \includegraphics[width=0.425\textwidth]{fig_fullRun2UL/TOP_PT/combined/HypToppT.pdf}
      \end{center}
