...
Vertexing is also important for the identification of secondary vertices (SV), i.e. vertices separated from the beamline by $\gtrsim \SI{1}{\mm}$ or more, which are usually attributed to the decay of short-lived heavy flavor mesons.
...
The \pT spectra of top quark and anti-quarks in \ttbar\ data are known to be softer than modeled by MC simulations.
