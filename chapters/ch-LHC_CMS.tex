...
\begin{cabstract}
This chapter describes the Large Hadron Collider (LHC) accelerator complex and the Compact Muon Solenoid (CMS) experiment. 
The design and operational principles of the LHC are discussed, emphasizing its role in the acceleration and collision of proton beams. 
Brief details of the CMS detector's subsystems, including the silicon tracker, calorimeters, and muon systems, are given to explain their roles in particle detection and identification. 
The CMS experiment's capabilities in testing SM predictions and exploring NP are highlighted.
\end{cabstract}
...
Surrounding the pixel tracker is the silicon strip tracker (see figure~\ref{Inner_Tracker}), consisting of 15,148 modules with 24,244 silicon sensors, that cover a total area of $\simeq \SI{198}{\m \squared}$, and altogether contains 9.6 million microstrips~\cite{Chatrchyan:1129810}.
...
Surrounding the silicon inner tracker is the electromagnetic calorimeter (ECAL), consisting of 61,200 lead tungstate (\ce{PbWO4}) scintillating crystals in the barrel region (EB) and 7,324 crystals in each of the end-caps (EC)~\cite{Bayatian:922757}.
...
The non-magnetic brass absorber layer is composed of 70\% \ce{Cu} and 30\% \ce{Zn} and has a nuclear interaction length of $\lambda_I = \SI{16.42}{\cm}$~\cite{Chatrchyan:1129810}.
