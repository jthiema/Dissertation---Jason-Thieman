...
%     }
\def\ZZtitle{Differential Measurements of Top Quark Polarizations and Spin Correlations in \lowercase{\ensuremath{\mathbf{t\bar{t}}}} Dilepton final states from \lowercase{\ensuremath{\mathbf{pp}}} collisions at \ensuremath{\mathbf{\sqrt{\lowercase{s}}=13~\text{T\lowercase{e}\hspace{-.08em}V}}} with the CMS Experiment}
...
\newcommand{\MGaMCatNLO} {MG5\_aMC@NLO(FxFx)} 
\newcommand{\MGaMCatNLOOnly} {MG5\_aMC@NLO} 
\newcommand{\MGMLM} {MG5\_aMC@NLO(MLM)} 
...
\renewcommand{\vv}{\ensuremath{\mathrm{WW/WZ/ZZ}}}
...
%     glossary
%     abstract
\include{chapters/ch-Front}

%
% Put chapter \include commands here.
%
\include{chapters/ch-Motivation_Theory}
\include{chapters/ch-Top_Quark_Physics}
\include{chapters/ch-LHC_CMS}
\include{chapters/ch-Event_Simulation}
\include{chapters/ch-Event_Reconstruction}
\include{chapters/ch-Event_Selection}
\include{chapters/ch-TTBar_Reconstruction}
\include{chapters/ch-Systematic_Uncertainties}
\include{chapters/ch-Cross_Section_Measurement}
...
\include{appendices/ap-TriggerSF}
\include{appendices/ap-FastTiming}
