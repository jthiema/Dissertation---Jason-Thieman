...
% \ConfigureBibliography
\newcommand{\ZZBibProcessor}{BibLaTeX}
%\usepackage[backend=biber, citestyle=numeric-comp, dashed=false, locallabelwidth=true, sortcites=true, style=ieee, refsegment=chapter, defernumbers=true]{biblatex}
\usepackage[backend=biber, citestyle=numeric-comp, dashed=false, locallabelwidth=true, sortcites=true, style=ieee, defernumbers=true]{biblatex}
\addbibresource{all-biblatex.bib}
